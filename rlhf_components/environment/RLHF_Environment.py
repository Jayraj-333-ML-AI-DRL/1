...
from utils import reward_shaping_human_feedback,reward_shaping
class RLHFEnvironment:
    ...
    def step(self, action,human_feedback, i):
        """
        ...
        reward = reward_shaping_human_feedback(action,human_feedback,i)
